...
<div id="middle">
	...
	<div class="sitenav">当前位置：
		...
		<a href="__ACTION__"><?php echo ($sitenav["1"]); ?></a>-
		<a href="__ACTION__"><?php echo ($sitenav["2"]); ?></a>
	</div>

		
	<div class="about_cont">
		<h2 class="title_h2"><?php echo ($data["headline"]); ?></h2>
		<div class="ly">作者： <?php echo ($data["author"]); ?> 发布于：<?php echo ($data["time"]); ?> 浏览量：</div>
		<div class="cont_info"><?php echo ($data["content"]); ?></div>
	</div>
