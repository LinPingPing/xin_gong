...
<div id="nav" class="">
	<ul id="continer">
		...
		<li class="nav_1"><a href="">党建工作</a>
			<ul>
				<li><a href="">政策法规</a></li>
				<li><a href="">支部活动</a></li>
			</ul>
		</li>
		<li class="nav_1"><a href="">招生就业</a></li>
...
<div id="middle">
	...
	<div class="sitenav">当前位置：
		...
		<a href="__URL__/xue_ke">学科建设</a>-
		<a href="__URL__/xue_ke">教师名录</a>
	</div>
	...
	<div class="about_cont">
		...
		<div class="teacher_info">
			...
			<div class="teacher_detal">
				<p><em>姓名：</em><?php echo ($data["name"]); ?></p>
				<p><em>电话：</em><?php echo ($data["contact"]); ?></p>
				<p><em>职称：</em><?php echo ($data["position_title"]); ?></p>
				<p><em>邮件：</em><?php echo ($data["email"]); ?></p>
			</div>
		</div>
