...
<div id="middle">
	...
	<div class="sitenav">当前位置：
		...
		<a href="__URL__/jie_shao"><?php echo ($sitenav["1"]); ?></a>-
		<a href="__URL__/jie_shao"><?php echo ($sitenav["2"]); ?></a>
	</div>
	...
	<div class="about_cont">
		...
		<ul class="list_cont">
			<?php if(is_array($list)): foreach($list as $key=>$vo): ?><li><span><?php echo ($vo["time"]); ?></span><a href="__ACTION__/tid/715/id/<?php echo ($vo["id"]); ?>"><?php echo ($vo["headline"]); ?></a></li><?php endforeach; endif; ?>
		</ul>
