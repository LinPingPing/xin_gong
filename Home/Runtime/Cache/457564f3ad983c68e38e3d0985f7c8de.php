...
<div id="middle">
	...
	<div class="sitenav">当前位置：
		...
		<a href="__URL__/jie_shao">学科建设</a>-
		<a href="__URL__/leader">学科带头人</a>
	</div>

		
<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="about_cont">
		<div class="leader">
			<h3><?php echo ($vo["other"]); ?></h3>
			<div class="pic_div">
				<div class="lead_pic"><img src="__PUBLIC__/Uploads/<?php echo ($vo["photo_name"]); ?>"/></div>
				<div class="lead_con">
					<h6><?php echo ($vo["name"]); ?></h6>
					<p><?php echo ($vo["position_title"]); ?><br/>研究方向：<?php echo ($vo["task"]); ?></p>
					<a href="__ACTION__/tid/10/id/<?php echo ($vo["id"]); ?>">详细了解>></a>
				</div>
			</div>
		</div>
